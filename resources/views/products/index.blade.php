...
@section('content')
        ...
        <h2>List Products </h2>
            ...
            <div class="col-sm col-md-4">
                <a href="{{route('products.create')}}"class="btn btn-outline-warning float-end">Add Product</a>
            </div>
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="{{ route('products.edit', ['id' => $product ->id]) }}" class="btn btn-warning mt-2">Edit</a>
                    </form>
